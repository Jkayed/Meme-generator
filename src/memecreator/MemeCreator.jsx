...
const MemeCreator = () => {
  ...
  return (
    <>
      <header className="page-header">Meme creator</header>
      <div style={{ display: "flex" }}>
        ...
        >
          {images.length == 0 ? (
            <h2 className="create-meme-label">Start creating memes!</h2>
          ) : (
            ""
          )}
        ...
        <div className="meme-creator-functions">
          <Card className="py-4 w-80 h-40 ml-10 mr-28 mt-5">
            <Input
              value={newText}
            ...
            <div style={{ display: "flex" }}>
              <Button
                ...
                className="w-48 mt-10 ml-4 text-white"
                color="success"
              >
                Add Text
              </Button>
          ...
          <Card className="py-4 w-80 h-40 ml-10 mr-28 mt-5">
            ...
            <Button
              ...
              className="w-60 m-auto text-white"
            >
              Save Meme
            </Button>
            <Button
